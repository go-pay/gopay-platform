...
ALTER TABLE `payment_order`
  ADD COLUMN `order_no`      VARCHAR(32)  NOT NULL DEFAULT '' COMMENT '平台订单号' AFTER `id`,
  ...
  ADD COLUMN `merchant_name` VARCHAR(64)  NOT NULL DEFAULT '' COMMENT '商户名称' AFTER `merchant_id`,
